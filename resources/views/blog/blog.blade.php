...
<section class="js-breadcrumb-area">
  ...
  <div class="js-blog-defalt-area js-blog-with-sidebar">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
            ...
            <article class="js-default-single-blog mb-50">
                    <div class="js-default-blog-thumbnail">
                      <img src="assets/images/blog/blog-thubmnail6.jpg" alt="thumbnail">
                      <ul class="js-post-author">
                       <li>
                         <a href="#">
                             <img src="assets/images/blog/default-post-author.png" alt="blog ahthor image">
                             <p class="js-default-author-content"><span>posted by</span>{{ $blog->user }}</p>
                         </a>
                       </li>
                      </ul>
                    </div><!-- js-default-blog-thumbnail -->
                   <div class="js-default-single-blog-content has-color">
                     <h3><a href="blog-single.html">{{ $blog->title }}</a></h3>
                     <ul class="list-inline">
                       <li><a href="#">{{ $blog->created_at }}</a></li>
                       <li><a href="#">Like 115</a></li>
                       <li><a href="#">{{ $blog->comments->count() }}</a></li>
                     </ul>
                     <p>Aliquam vestibulum morbi blandit cursus risus. Velit dignissim sodales Condimentum ..</p>
                     <a href="blog-single.html" class="js-blog-read-more">Read More</a>
            ...
            <div class="js-post-pagination pagination-style2">
              <div class="row">
                <div class="col-lg-6">
        ...
        <div class="col-lg-4">
          <aside class="sidebar-widget">
            <div class="widget bg-white">
              ...
              <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, believable. If you are going to u.se a passage of Lorem Ipsum, you need.</p>
            ...
            <div class="widget bg-white">
              <img src="assets/images/blog/widget-add.png" alt="add">
            </div><!-- widget End-->
            <div class="widget bg-white">
               <div class="js-widget-social-icon">
                 <ul class="list-inline">
                   <li>
                     <a href="#">
                       <i><img src="assets/images/blog/facebook.png" alt="facebook"></i>
                   ...
                   <li>
                     <a href="#">
                       <i><img src="assets/images/blog/twitter.png" alt="twitter"></i>
                   ...
                   <li>
                     <a href="#">
                       <i><img src="assets/images/blog/ig.png" alt="ig"></i>
